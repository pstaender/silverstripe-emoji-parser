...
class Emojis extends TextParser
{
    ...
    public function parse()
    {
        ...
        $s = $this->content;
        foreach (explode(',', $this->getEmojis()) as $emoji) {
...
class Emojis_Controller extends Controller
{
    ...
    public function index()
    {
        ...
        foreach (explode(',', $parser->getEmojis()) as $emoji) {
            $data[$emoji] = $basePath.$emoji.'.png';
        }
